    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmViewer", x => new { x.FavoritesId, x.ViewersId });
                    table.ForeignKey(
                        name: "FK_FilmViewer_Film_FavoritesId",
                        column: x => x.FavoritesId,
                        principalTable: "Film",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmViewer_User_ViewersId",
